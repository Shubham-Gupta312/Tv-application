...
$(document).on('click', '.active', function () {
    ...
    $.ajax({
        method: 'POST',
        url: "/admin/setPreciousActiveStatus",
        data: {
        'id': programId,
    },
        dataType: 'json',
...
$(document).on('click', '#delete', function (e) {
    ...
    $.ajax({
        method: "POST",
        url: "/admin/delete_preciousProgram",
        data: {
            'id': programId
        },
        success: function (response) {
...
$(document).on('click', '#update', function (e) {
    ...
    $.ajax({
        method: "POST",
        url: "/admin/edit_preciousProgramData",
        data: {
            'id': programId,
        },
        success: function (response) {
...
$('#update_data').click(function (e) {
    ...
    $.ajax({
        method: "POST",
        url: "/admin/update_preciousProgramData",
        data: data,
        success: function (response) {
            // console.log(response);
            if (response.status == 'success') {
